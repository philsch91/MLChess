//
//  MLSliderCollectionViewCell.swift
//  MLChess
//
...
class MLSliderCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        self.slider.frame = bounds.inset(by: UIEdgeInsets(top: 6, left: 10, bottom: 6, right: 10))
